#ifndef __ENCRYPTEDDWORD_H_
#define __ENCRYPTEDDWORD_H_
...
virtual void SetValue(DWORD val) {
__asm {
mr  r6, r7
insrwi  r6, r7, 16,0
...
virtual int CallFunc(DWORD FuncNum, DWORD arg1) {
