...
namespace ENTITY
{
	...
	static float GET_ENTITY_ROTATION(Any p0, Any p1) { return invoke<float>(0x8FF45B04, p0, p1); } // 0x8FF45B04
	static Vector3 GET_ENTITY_ROTATION_VELOCITY(Any p0) { return invoke<Vector3>(0x9BF8A73F, p0); } // 0x9BF8A73F
	static Vector3 GET_WORLD_POSITION_OF_ENTITY_BONE(Entity entity, int boneIndex) { return invoke<Vector3>(0x7C6339DF, entity, boneIndex); }
	...
	static int GET_ENTITY_BONE_INDEX_BY_NAME(Entity entity, char *boneName) { return invoke<int>(0xE4ECAC22, entity, *boneName); }
...
namespace PED
{
	...
	static float GET_PED_BONE_COORDS(Ped ped, int i1, float f1, float f2, float f3) { return invoke<float>(0x4579CAB1, ped, i1, f1, f2, f3); } // 0x4579CAB1
...
namespace VEHICLE
{
	...
	static void SET_VEHICLE_MOD_COLOR_1(Vehicle vehicle, int mod, int index, int var) { invoke<Void>(0xCBE9A54D, vehicle, mod, index, var); } // 0xCBE9A54D
	static void SET_VEHICLE_MOD_COLOR_2(Vehicle vehicle, int mod, int index, int var) { invoke<Void>(0xC32613C2, vehicle, mod, index, var); } // 0xC32613C2
	
	static void GET_VEHICLE_MOD_COLOR_1(Vehicle vehicle, int *mod, int *index, int *var) { invoke<Void>(0xE625510A, vehicle, mod, index, var); } // 0xE625510A
	static void GET_VEHICLE_MOD_COLOR_2(Vehicle vehicle, int *mod, int *index, int *var) { invoke<Void>(0x9B76BB8E, vehicle, mod, index, var); } // 0x9B76BB8E
	
	static void SET_VEHICLE_EXTRA_COLOURS(Vehicle vehicle, int p1, int p2) { invoke<Void>(0x515DB2A0, vehicle, p1, p2); } // 0x515DB2A0
	static void GET_VEHICLE_EXTRA_COLOURS(Vehicle vehicle, int *p1, int *p2) { invoke<Void>(0x80E4659B, vehicle, p1, p2); } // 0x80E4659B
	...
	//static Any SET_HELI_BLADES_FULL_SPEEDv2(Any p0) { return invoke<Any>(0x033A9408, p0); } // 0x033A9408
	...
	static void SET_VEHICLE_TYRE_SMOKE_COLOR1(Any p0, Any p1, Any p2, Any p3) { invoke<Void>(0x3EDEC0DB, p0, p1, p2, p3); } // 0x3EDEC0DB
...
namespace OBJECT
{
	...
	static Any CREATE_PORTABLE_PICKUP(Hash pickupHash, float x, float y, float z, BOOL p4, Any p5) { return invoke<Any>(0x8C886BE5, x, y, z, p4, p5); } // 0x8C886BE5
	static Any _CREATE_UNK1_PICKUP(Hash pickupHash, float x, float y, float z, BOOL p4, Hash modelHash) { return invoke<Any>(0x56A02502, pickupHash, x, y, z, p4, modelHash); } // 0x56A02502
...
namespace WEAPON
{
	...
	//static Any GET_PED_LAST_WEAPON_IMPACT_COORD(Ped Handle, float* Coords) { return invoke<Any>(0x6C4D0409BA1A2BC2, Handle, Coords); }
...
namespace STREAMING
{
	...
	static void REQUEST_NAMED_PTFX_ASSET(char *fxName) { invoke<Void>(0xCFEA19A9, *fxName); } // 0x546C627A
...
namespace UI
{
	...
	static int _DRAW_NOTIFICATIONv2(BOOL blink, BOOL p1, int R, int G, int B, int A) { return invoke<int>(0x08F7AF78,0xDD2BFC77, blink, p1, R,G,B,A); } // 0x08F7AF78int R, int G, int B, int A
	...
	static int _SET_NOTIFICATION_MESSAGE_CLAN_TAG_2(char *picName1, char *picName2, BOOL flash, int iconType, char *sender, char *subject, float duration, char *clanTag, int iconType2) { return invoke<int>(0xDEB491C8, *picName1, *picName2, flash, iconType, *sender, *subject, duration, *clanTag, iconType2); } // 0x531B84E7DA981FB6 0xDEB491C8
...
namespace GRAPHICS
{
	...
	static void _SET_PTFX_ASSET_NEXT_CALL(char *name) { invoke<Void>(0x9C720B61, *name); }
...
namespace NETWORK
{
	...
	static Any _0xF8D7AF3B(Any p0) { return invoke<Any>(0xF8D7AF3B, p0); } // 0xD19B312C
