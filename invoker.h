...
static Native_s** g_Natives = (Native_s**)0x83DDCD08;
static NativeArg_s* NativeArg = (NativeArg_s*)0x83DBC000;

//Every title update you have to update the nativeTable address for TU26 it is 0x83DDC8F8 to update it search for this unique byte pattern in IDA "3B FF 00 01 7D 66 29 2E  81 64 00 20 38 C6 00 04" and it will bring you to the end of a function, scroll up and you will see something like this http://puu.sh/jZSSH/63bc577317.png that unk_xxxxxxx is the address you need
